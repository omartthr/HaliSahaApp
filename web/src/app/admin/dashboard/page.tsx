...
const AdminDashboard = () => {
      ...
      <div style={{ display: "flex", overflowX: "auto", gap: 8, paddingBottom: 4 }}>
        {BOOKING_FILTERS.map((f) => (
          <button key={f.id} onClick={() => setBookingFilter(f.id)}
            style={{ padding: "8px 16px", borderRadius: 20, border: "none", cursor: "pointer", fontWeight: 600, fontSize: 13, whiteSpace: "nowrap",
  ...
  return (
    <div className="page-wrapper" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div className="content-container" style={{ position: "relative", zIndex: 2, paddingBottom: 60, maxWidth: 1100, width: "100%", margin: "-210px auto 0" }}>
